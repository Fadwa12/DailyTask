...
<head>
  ...
  <link href="Resources/lib/prettyphoto/css/prettyphoto.css" rel="stylesheet">
  <link href="Resources/lib/hover/hoverex-all.css" rel="stylesheet">
  <link href="Resources/lib/jetmenu/jetmenu.css" rel="stylesheet">
  <link href="Resources/lib/owl-carousel/owl-carousel.css" rel="stylesheet">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="search-bar">
          <form action="" method="get">
            <fieldset>
              <input type="image" src="Resources/img/pixel.gif" class="searchsubmit" alt="" />
...
<!--         </div> -->
    ...
    <div class="container">
      ...
      <div class="widget col-lg-3 col-md-3 col-sm-12">
        ...
        <ul class="recent_posts">
          <li>
            <a href="home1.html#">
						<img src="Resources/img/recent_post_01.png" alt="" />Our New Dashboard Is Here</a>
            <a class="readmore" href="#">read more</a>
          </li>
          <li>
            <a href="home1.html#">
						<img src="Resources/img/recent_post_02.png" alt="" />Design Is In The Air</a>
            <a class="readmore" href="#">read more</a>
          </li>
        </ul>
        <!-- recent posts -->
      ...
      <div class="widget col-lg-3 col-md-3 col-sm-12">
        ...
        <ul class="flickr">
          <li><a href="#"><img alt="" src="Resources/img/flickr_01.jpg"></a></li>
          <li><a href="#"><img alt="" src="Resources/img/flickr_02.jpg"></a></li>
          <li><a href="#"><img alt="" src="Resources/img/flickr_03.jpg"></a></li>
          <li><a href="#"><img alt="" src="Resources/img/flickr_04.jpg"></a></li>
          <li><a href="#"><img alt="" src="Resources/img/flickr_05.jpg"></a></li>
          <li><a href="#"><img alt="" src="Resources/img/flickr_06.jpg"></a></li>
          <li><a href="#"><img alt="" src="Resources/img/flickr_07.jpg"></a></li>
          <li><a href="#"><img alt="" src="Resources/img/flickr_08.jpg"></a></li>
        </ul>
      </div>
      <!-- end widget -->
    </div>
  ...
  <script src="Resources/lib/unveil-effects/unveil-effects.js"></script>
  <script src="Resources/lib/owl-carousel/owl-carousel.js"></script>
  <script src="Resources/lib/jetmenu/jetmenu.js"></script>
  <script src="Resources/lib/animate-enhanced/animate-enhanced.min.js"></script>
  <script src="Resources/lib/jigowatt/jigowatt.js"></script>
  <script src="Resources/lib/easypiechart/easypiechart.min.js"></script>
