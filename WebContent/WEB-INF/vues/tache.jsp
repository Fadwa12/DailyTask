    ...
    <div class="container clearfix">
      ...
      <div id="sidebar" class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        ...
        <div class="widget">
          ...
          <form id="subscribe" action="tache" name="subscribe" method="post">
            <input type="text" name="nom" id="nom" class="form-control" placeholder="Task name">
           ...
           <input type="text" name="description" id="description" class="form-control" placeholder="Description">
            ...
            <div class="pull-right">
              ...
              <input type="submit" value="Add" id="submit" class="button">
            </div>
          </form>
        </div>
